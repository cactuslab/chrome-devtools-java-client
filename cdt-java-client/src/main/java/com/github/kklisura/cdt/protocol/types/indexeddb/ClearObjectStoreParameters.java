...
public class ClearObjectStoreParameters {
   ...
   * Security origin.
   */
  public ClearObjectStoreParameters setSecurityOrigin(String securityOrigin) {
  ...
  /** Storage key. */
  public ClearObjectStoreParameters setStorageKey(String storageKey) {
  ...
  /** Storage bucket. If not specified, it uses the default bucket. */
  public ClearObjectStoreParameters setStorageBucket(StorageBucket storageBucket) {
  ...
  /** Database name. */
  public ClearObjectStoreParameters setDatabaseName(String databaseName) {
  ...
  /** Object store name. */
  public ClearObjectStoreParameters setObjectStoreName(String objectStoreName) {
