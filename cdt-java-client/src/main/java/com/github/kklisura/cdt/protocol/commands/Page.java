...
public interface Page {
  ...
  AdAncestry getAdScriptAncestry(@ParamName("frameId") String frameId);
   ...
   * subject to change.
   *
   * @param includeActionableInformation Whether to include actionable information. Defaults to
   *     true.
   */
  @Experimental
  @Returns("content")
