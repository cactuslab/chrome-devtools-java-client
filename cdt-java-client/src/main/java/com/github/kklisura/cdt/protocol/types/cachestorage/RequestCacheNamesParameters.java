...
public class RequestCacheNamesParameters {
   ...
   * Security origin.
   */
  public RequestCacheNamesParameters setSecurityOrigin(String securityOrigin) {
  ...
  /** Storage key. */
  public RequestCacheNamesParameters setStorageKey(String storageKey) {
  ...
  /** Storage bucket. If not specified, it uses the default bucket. */
  public RequestCacheNamesParameters setStorageBucket(StorageBucket storageBucket) {
