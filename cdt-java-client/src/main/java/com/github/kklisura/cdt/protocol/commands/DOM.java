...
import com.github.kklisura.cdt.protocol.events.dom.AdRelatedStateUpdated;
import com.github.kklisura.cdt.protocol.events.dom.AdoptedStyleSheetsModified;
...
public interface DOM {
  ...
  @Experimental
  EventListener onAdoptedStyleSheetsModified(
      EventHandler<AdoptedStyleSheetsModified> eventListener);
  ...
  @Experimental
  EventListener onAdRelatedStateUpdated(EventHandler<AdRelatedStateUpdated> eventListener);
