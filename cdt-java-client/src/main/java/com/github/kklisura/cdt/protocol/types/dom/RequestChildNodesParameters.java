...
public class RequestChildNodesParameters {
  ...
  /** Id of the node to get children for. */
  public RequestChildNodesParameters setNodeId(Integer nodeId) {
    this.nodeId = nodeId;
    return this;
  }
   ...
   * subtree or provide an integer larger than 0.
   */
  public RequestChildNodesParameters setDepth(Integer depth) {
    this.depth = depth;
    return this;
  }
   ...
   * (default is false).
   */
  public RequestChildNodesParameters setPierce(Boolean pierce) {
    this.pierce = pierce;
    return this;
  }
}
