...
public class SetShowHingeParameters {
  ...
  @Optional
  @ParamName("hingeConfig")
  private HingeConfig hingeConfig;

  /** hinge data, null means hideHinge */
  public HingeConfig getHingeConfig() {
    return hingeConfig;
  }

  /** hinge data, null means hideHinge */
  public SetShowHingeParameters setHingeConfig(HingeConfig hingeConfig) {
