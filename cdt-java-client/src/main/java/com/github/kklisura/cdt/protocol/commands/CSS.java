...
import com.github.kklisura.cdt.protocol.types.css.CSSNavigation;
...
public interface CSS {
  ...
  /**
   * Modifies the expression of a container query. Deprecated. Use setContainerQueryConditionText
   * instead.
   *
   * @param styleSheetId
   * @param range
  ...
  @Experimental
  @Returns("containerQuery")
  CSSContainerQuery setContainerQueryConditionText(
      @ParamName("styleSheetId") String styleSheetId,
      @ParamName("range") SourceRange range,
      @ParamName("text") String text);
  ...
  @Experimental
  @Returns("navigation")
  CSSNavigation setNavigationText(
      @ParamName("styleSheetId") String styleSheetId,
      @ParamName("range") SourceRange range,
      @ParamName("text") String text);
