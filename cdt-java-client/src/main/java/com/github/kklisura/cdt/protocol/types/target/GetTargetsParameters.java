...
public class GetTargetsParameters {
   ...
   * is currently enabled, a filter used for target discovery is used for consistency.
   */
   ...
   * is currently enabled, a filter used for target discovery is used for consistency.
   */
  public GetTargetsParameters setFilter(List<FilterEntry> filter) {
    this.filter = filter;
    return this;
  }
}
