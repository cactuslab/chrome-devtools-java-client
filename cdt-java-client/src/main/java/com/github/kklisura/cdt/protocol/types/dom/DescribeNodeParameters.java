...
public class DescribeNodeParameters {
  ...
  /** Identifier of the node. */
  public DescribeNodeParameters setNodeId(Integer nodeId) {
    this.nodeId = nodeId;
    return this;
  }
  ...
  /** Identifier of the backend node. */
  public DescribeNodeParameters setBackendNodeId(Integer backendNodeId) {
  ...
  /** JavaScript object id of the node wrapper. */
  public DescribeNodeParameters setObjectId(String objectId) {
   ...
   * subtree or provide an integer larger than 0.
   */
  public DescribeNodeParameters setDepth(Integer depth) {
    this.depth = depth;
    return this;
  }
   ...
   * is false).
   */
  public DescribeNodeParameters setPierce(Boolean pierce) {
    this.pierce = pierce;
    return this;
  }
}
