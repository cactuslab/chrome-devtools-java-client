...
public class GetMetadataParameters {
   ...
   * Security origin.
   */
  public GetMetadataParameters setSecurityOrigin(String securityOrigin) {
  ...
  /** Storage key. */
  public GetMetadataParameters setStorageKey(String storageKey) {
  ...
  /** Storage bucket. If not specified, it uses the default bucket. */
  public GetMetadataParameters setStorageBucket(StorageBucket storageBucket) {
  ...
  /** Database name. */
  public GetMetadataParameters setDatabaseName(String databaseName) {
  ...
  /** Object store name. */
  public GetMetadataParameters setObjectStoreName(String objectStoreName) {
