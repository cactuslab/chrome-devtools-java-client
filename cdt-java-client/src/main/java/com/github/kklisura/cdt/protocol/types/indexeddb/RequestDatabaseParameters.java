...
public class RequestDatabaseParameters {
   ...
   * Security origin.
   */
  public RequestDatabaseParameters setSecurityOrigin(String securityOrigin) {
  ...
  /** Storage key. */
  public RequestDatabaseParameters setStorageKey(String storageKey) {
  ...
  /** Storage bucket. If not specified, it uses the default bucket. */
  public RequestDatabaseParameters setStorageBucket(StorageBucket storageBucket) {
  ...
  /** Database name. */
  public RequestDatabaseParameters setDatabaseName(String databaseName) {
