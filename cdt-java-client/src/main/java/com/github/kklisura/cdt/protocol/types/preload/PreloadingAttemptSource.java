 ...
 * rule that triggered the attempt, and the BackendNodeIds of &lt;a href&gt; or &lt;area href&gt;
 * elements that triggered the attempt (in the case of attempts triggered by a document rule). It is
