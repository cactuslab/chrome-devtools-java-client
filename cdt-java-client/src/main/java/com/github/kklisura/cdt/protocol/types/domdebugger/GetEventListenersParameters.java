...
public class GetEventListenersParameters {
  ...
  /** Identifier of the object to return listeners for. */
  public GetEventListenersParameters setObjectId(String objectId) {
   ...
   * entire subtree or provide an integer larger than 0.
   */
  public GetEventListenersParameters setDepth(Integer depth) {
    this.depth = depth;
    return this;
  }
   ...
   * is false). Reports listeners for all contexts if pierce is enabled.
   */
   ...
   * is false). Reports listeners for all contexts if pierce is enabled.
   */
  public GetEventListenersParameters setPierce(Boolean pierce) {
    this.pierce = pierce;
    return this;
  }
}
