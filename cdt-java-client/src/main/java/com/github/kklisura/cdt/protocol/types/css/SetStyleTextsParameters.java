...
public class SetStyleTextsParameters {
  ...
  public List<StyleDeclarationEdit> getEdits() {
    return edits;
  }

  public SetStyleTextsParameters setEdits(List<StyleDeclarationEdit> edits) {
    this.edits = edits;
    return this;
  }
   ...
   * example.
   */
  public SetStyleTextsParameters setNodeForPropertySyntaxValidation(
